...
inner join {{ ref('stg_nations') }} as nations on suppliers.nation_key = nations.nation_key
inner join {{ ref('stg_regions') }} as regions on nations.region_key = regions.region_key
where
    regions.name = 'ASIA'
